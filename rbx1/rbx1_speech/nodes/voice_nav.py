...
class VoiceNav:
    def __init__(self):
        ...
        self.keywords_to_command = {'stop': ['stop', 'abort', 'kill', 'panic', 'freeze', 'turn off'],
                                    'search': ['search','come'],
                                    'faster': ['speed up', 'faster'],
                                    'forward': ['forward', 'ahead', 'straight','go'],
                                    'backward': ['back', 'back up'],
    ...
    def speech_callback(self, msg):
        ...
        if command == 'forward':    
            ...
            print("begin to search color")
	    print os.system('rosrun turtlebot_project ARtracker ')
